    ...
    <div class="col-12 col-md-8 mx-auto">
        <div class="card">
            <div class="card-body text-center py-5">
                <h1 class="display-5 mb-3">Samahani, kuna hitilafu upande wetu</h1>
                <p class="text-muted mb-4">Kuna tatizo la ndani ya mfumo (500). Timu yetu inafanya kazi kulitatua. Tafadhali jaribu tena baadae.</p>
                <div class="mb-4">
