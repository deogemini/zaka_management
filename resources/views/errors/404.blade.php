    ...
    <div class="col-12 col-md-8 mx-auto">
        <div class="card">
            <div class="card-body text-center py-5">
                <h1 class="display-5 mb-3">Samahani, ukurasa haukupatikana</h1>
                <p class="text-muted mb-4">Hatukuweza kupata ukurasa unaotafuta (404). Inawezekana umehamishwa au haupo tena.</p>
                <div class="mb-4">
